...
public class PutObjectSamples {
    ...
    public PutObjectSamples(OSS client, String testBucket, String testObject, String uploadFilePath,UploadListener uploadListener) {
        this.oss = client;
    ...
    public void asyncPutObjectFromLocalFile() {
        ...
        OSSAsyncTask task = oss.asyncPutObject(put, new OSSCompletedCallback<PutObjectRequest, PutObjectResult>() {
            ...
            public void onSuccess(PutObjectRequest request, PutObjectResult result) {
                Log.d("PutObject", "UploadSuccess");
                uploadListener.uploadSucc(request.getObjectKey());
            ...
            public void onFailure(PutObjectRequest request, ClientException clientExcepion, ServiceException serviceException) {
                ...
                uploadListener.uploadFail("上传失败");
            }
        });
    }
